...
const Assets_Route = require('./Routes/Assets_Route');
const Payment_Route = require('./Routes/PayRoute'); 
const Liability_Route = require("./Routes/Liability_Route");
...
app.use("/Liabilities",Liability_Route);
